...
/**
 * 数据看盘数据
 * @param todayBrowseAmount: 今日浏览量
 * @param todayExposureAmount：今日曝光量
 * @param timeCycle：时间周期
 * @param timeType：时间类型
 */
function lineChartOption(todayBrowseAmount, todayExposureAmount, timeCycle, timeType) {
    let option = {
        legend: {
            orient: 'horizontal',
            x: 'center',
